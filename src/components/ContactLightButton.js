import styles from './ContactLightButton.module.css'
import { useParams } from 'react-router-dom'
import data from '../database/data'

const ContactLightButton = () => {
    const { id } = useParams()
    ...
    return (
        <button className={styles.ContactLightButton} onClick={handleModal}>Quero Esse</button>
    )
}

export default ContactLightButton